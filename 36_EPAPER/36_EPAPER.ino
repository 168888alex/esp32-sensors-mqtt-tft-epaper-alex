...
void drawDashboard(bool dhtValid,int temp,int humi,bool lightValid,int light)
{
  ...
  fillRect(0,0,296,16,RED);
  drawTextCentered(148,0,"ESP32 SENSOR",1,WHITE);
  drawLine(8,16,288,16,RED);
...
void setup()
{
  Serial.begin(115200); delay(1000); analogReadResolution(12); SPI.begin(18,-1,23,27); updateDisplay();
}

void loop()
{
  static unsigned long lastUpdate=millis();
  if(millis()-lastUpdate>=60000UL){lastUpdate=millis();updateDisplay();}
  delay(100);
}
